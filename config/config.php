...
return [
    ...
    'routes' => [
        ...
        ['route' => '/images/changes/professions', 'methods' => ['GET'], 'controller' => Controller\ProfessionChangeImageController::class],
        ['route' => '/images/{world}-profession-changes.png', 'methods' => ['GET'], 'controller' => Controller\ProfessionChangeImageDisplayController::class],
        ...
        ['route' => '/images/changes/bans-and-deletions', 'methods' => ['GET'], 'controller' => Controller\BanAndDeletionImageController::class],
        ['route' => '/images/{world}-bans-and-deletions.png', 'methods' => ['GET'], 'controller' => Controller\BanAndDeletionImageDisplayController::class],
    ...
    'factories' => [
        ...
        Controller\ProfessionChangeImageController::class => Controller\Factory\ProfessionChangeImageControllerFactory::class,
        Controller\ProfessionChangeImageDisplayController::class => Controller\Factory\ProfessionChangeImageDisplayControllerFactory::class,
        ...
        Controller\BanAndDeletionImageController::class => Controller\Factory\BanAndDeletionImageControllerFactory::class,
        Controller\BanAndDeletionImageDisplayController::class => Controller\Factory\BanAndDeletionImageDisplayControllerFactory::class,
